"""
Comparison Script: EfficientNet-B0 - 2 Epochs
Dataset  : ../dataset  (11-class)
Model    : EfficientNet-B0 (ImageNet pretrained)
Output   : training/results/efficientnet_b0_2epochs.pth + efficientnet_b0_comparison.txt
"""
import os, time
import torch
...
SAVE_PATH   = os.path.join(RESULTS_DIR, "efficientnet_b0_2epochs.pth")
LOG_PATH    = os.path.join(RESULTS_DIR, "efficientnet_b0_comparison.txt")
...
try:    model = models.efficientnet_b0(weights=models.EfficientNet_B0_Weights.IMAGENET1K_V1)
except: model = models.efficientnet_b0(pretrained=True)
