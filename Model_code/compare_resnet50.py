"""
Comparison Script: ResNet-50 - 2 Epochs
========================================
Dataset  : ../dataset  (11-class, nested structure)
Model    : ResNet-50 (ImageNet pretrained)
Epochs   : 2
Output   : training/results/resnet50_2epochs.pth
           training/results/resnet50_comparison.txt
"""
...
SAVE_PATH   = os.path.join(RESULTS_DIR, "resnet50_2epochs.pth")
LOG_PATH    = os.path.join(RESULTS_DIR, "resnet50_comparison.txt")
BATCH_SIZE  = 32
EPOCHS      = 2
LR          = 1e-4
VAL_SPLIT   = 0.2
