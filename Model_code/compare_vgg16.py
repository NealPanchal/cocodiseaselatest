"""
Comparison Script: VGG-16 - 10 Epochs
Dataset  : ../dataset  (11-class)
Model    : VGG-16 (ImageNet pretrained)
Output   : training/results/vgg16_2epochs.pth + vgg16_comparison.txt
"""
import os, time
import torch
...
SAVE_PATH   = os.path.join(RESULTS_DIR, "vgg16_2epochs.pth")
LOG_PATH    = os.path.join(RESULTS_DIR, "vgg16_comparison.txt")
...
try:    model = models.vgg16(weights=models.VGG16_Weights.IMAGENET1K_V1)
except: model = models.vgg16(pretrained=True)
